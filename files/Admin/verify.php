...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<div class="main-content">
	    ...
	    $query = "SELECT formatted_id, first_name, middle_name, last_name, driver_category, association, verification_stat FROM tbl_driver WHERE verification_stat = 'Pending'";
