...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<div class="main-content">
        ...
        // Check if 'association_name' is set in the GET request
        $association_name = isset($_GET['association_name']) ? mysqli_real_escape_string($connections, $_GET['association_name']) : '';

        // Check if 'vehicle' is set in the GET request
        $driver_category = isset($_GET['driver_category']) ? mysqli_real_escape_string($connections, $_GET['driver_category']) : '';


        // Modify the query to filter by association name if provided
        $query = "SELECT d.formatted_id, d.first_name, d.middle_name, d.last_name, d.address, d.mobile_number, a.association_name, a.association_area, d.verification_stat, d.renew_stat 
                FROM tbl_driver d
                LEFT JOIN tbl_association a ON d.fk_association_id = a.association_id
                WHERE d.verification_stat = 'Registered'";

        // Add a condition to filter by association if the parameter is provided
        if (!empty($association_name)) {
            $query .= " AND a.association_name = '$association_name'";
        }

        // Add a condition to filter by driver category if the parameter is provided
            ...
            <table class="table table-bordered datatable" id="table-4">
                <thead>
                    <tr>
                        ...
                        <th style="color: #48484C;">Address</th>
                        <th style="color: #48484C;">Mobile Number</th>
