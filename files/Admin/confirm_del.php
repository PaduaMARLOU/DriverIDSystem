...
<body>
    <style>
        ...
        .background {
            ...
            width: 100%;
            height: 100%;
            background-image: url('../../img/prevent.jpg');
    ...
    <div class="background"></div>
        <center class="all"><br>
            <h1 class="confirmation">Admin Decline Confirmation</h1>
            <div class="container">
                <h2 class="confirm">Are you sure you want to deny <?php echo htmlspecialchars($f_name); ?>?</h2>
