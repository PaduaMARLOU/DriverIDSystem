...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="admin styles/unaccess.css"> <!-- External stylesheet link -->
...
<body>
    <style>
        .background {
            ...
            width: 100%;
            height: 100%;
            background-image: url('../../img/mysterious place.jpg'); /* Corrected the backslash */
