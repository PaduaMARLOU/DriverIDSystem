...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<div class="main-content">
        ...
        // Get the violation category from the URL parameter
        $violation_category = isset($_GET['violation_category']) ? $_GET['violation_category'] : '';
        ...
        if ($violation_category) {
            $query .= " AND v.violation_category = '$violation_category'";
        }

        // Add order clause
        $query .= " ORDER BY v.violation_date ASC";
            ...
            <table class="table table-bordered datatable" id="table-4">
                <thead>
                    <tr>
                        ...
                        <th style="color: #48484C;">Violation Category</th>
                        <th style="color: #48484C;">Violation Date</th>
                        <th style="color: #48484C;">Violation Status</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        // Initialize violation count for the driver if not already set
                        if (!isset($driver_violations[$driver_id])) {
                            $driver_violations[$driver_id] = 0;
                        }

                        // If renewed_date is NULL, count it as a violation
                        $violation_status = "Renewed";
                        if ($row['renewed_date'] == NULL) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['violation_category']; ?></td>
                            <td><?php echo $row['violation_date']; ?></td>
                            <td class="center"><?php echo $violation_status; ?></td>
                        </tr>
                    <?php
                    }
                    ?>
