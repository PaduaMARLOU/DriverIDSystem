...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2024 at 09:24 PM
...
INSERT INTO `tbl_association` (`association_id`, `association_category`, `association_name`, `association_area`, `association_color`, `association_color_name`) VALUES
(1, 'E-Bike', 'SAVEMORE SOUTH', 'SAVEMORE SOUTH', '', ''),
(2, 'E-Bike', 'BEETDOA', 'SAVEMORE NORTH', '', ''),
(3, 'E-Bike', 'EH2HEDOA', 'EAST HOMES 2', '', ''),
(4, 'E-Bike', 'CHETODA', 'CELINE HOMES', '', ''),
(5, 'E-Bike', 'BEETODA', 'SAVEMORE', '', ''),
(6, 'E-Bike', 'ESTODA', 'EAST HOMES 1', '', ''),
(7, 'E-Bike', 'EAST HOMES 3', 'EAST HOMES 3', '', ''),
(8, 'E-Bike', 'VILLA ALEXANDRA 1', 'VILLA ALEXANDRA 1', '', ''),
(9, 'E-Bike', 'EAST VILLAS', 'EAST VILLAS', '', ''),
(10, 'E-Bike', 'VILLA VILLETA', 'VILLA VILLETA', '', ''),
(11, 'E-Bike', 'VILLA SOLEDAD', 'VILLA SOLEDAD', '', ''),
(12, 'E-Bike', 'CCEDOA', 'CITY VILLE', '', '');
...
--
ALTER TABLE `tbl_association`
  MODIFY `association_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
